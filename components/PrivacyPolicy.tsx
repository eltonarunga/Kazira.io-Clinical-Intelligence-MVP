...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="space-y-4 text-sm text-ink/80 font-sans">
      ...
      <h3 className="text-lg font-bold text-ink font-serif mt-6">1. Data Collection and Processing</h3>
      ...
      <h3 className="text-lg font-bold text-ink font-serif mt-6">2. Third-Party AI Processors</h3>
      ...
      <div className="p-4 bg-accent/10 border-l-4 border-accent rounded-r-lg mt-4">
        <p className="font-bold text-accent m-0">AI Training Policy</p>
        <p className="text-accent/90 mt-1">We do not permit our AI partners to use your submitted data to train their foundational models. Your data is used exclusively for generating your specific report.</p>
      </div>

      <h3 className="text-lg font-bold text-ink font-serif mt-6">3. Data Retention</h3>
      ...
      <h3 className="text-lg font-bold text-ink font-serif mt-6">4. Security Measures and Prohibitions</h3>
      ...
      <p className="font-bold text-ink">As detailed in our Terms of Service, any unauthorized scraping, vulnerability testing, or security circumvention of Kazira.io is strictly prohibited and will be met with legal action.</p>

      <h3 className="text-lg font-bold text-ink font-serif mt-6">5. Changes to This Privacy Policy</h3>
