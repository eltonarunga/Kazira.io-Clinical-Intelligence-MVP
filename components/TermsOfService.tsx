...
const TermsOfService: React.FC = () => {
  return (
    <div className="space-y-4 text-sm text-ink/80 font-sans">
      ...
      <h3 className="text-lg font-bold text-ink font-serif mt-6">1. Prohibited Activities and Security</h3>
      ...
      <div className="p-4 bg-warn/10 border-l-4 border-warn rounded-r-lg mt-4">
        <p className="font-bold text-warn m-0">Legal Repercussions</p>
        <p className="text-warn/90 mt-1">Violation of these security rules may result in immediate termination of your access and civil or criminal liability. We will investigate occurrences that may involve such violations and may involve, and cooperate with, law enforcement authorities in prosecuting users who are involved in such violations.</p>
      </div>

      <h3 className="text-lg font-bold text-ink font-serif mt-6">2. Intellectual Property</h3>
      ...
      <h3 className="text-lg font-bold text-ink font-serif mt-6">3. Limitation of Liability</h3>
      ...
      <h3 className="text-lg font-bold text-ink font-serif mt-6">4. Governing Law</h3>
